...
<div class="panel panel-default">
  ...
  <div class="row">
      <form action="{{ route('products.index') }}" class="form-inline search-form">
        <input type="text" class="form-control input-sm" name="search" placeholder="搜尋">
        ...
        <select name="order" class="form-control input-sm pull-right">
          ...
          <option value="sold_count_desc">銷售由高到低</option>
          <option value="sold_count_asc">銷售由低到高</option>
